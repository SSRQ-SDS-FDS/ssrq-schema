...
def test_add_span(
    ...
    # In this test, the surrounding p element is the root for the test,
    # because addSpan always needs a corresponding element with
    # a xml:id to be valid. If addSpan was the root, all rng-tests would fail.
